...
for root, dirs, files in os.walk(dir):
    for file in files:
        ...
        img = load_img(dir+"\\"+name+".bmp",target_size=(512,512))
        label = load_img("D:\dataset\data-train\label\\"+name+"_anno.bmp",grayscale = True,target_size=(512,512))
...
for root, dirs, files in os.walk(dir):
    for file in files:
        ...
        img = load_img(dir+"\\"+name+".bmp",grayscale = True,target_size=(512,512))
